...
CREATE TABLE IF NOT EXISTS `boxsteps`.`plans` (
  ...
  `conceptual_sections_id` INT(10) UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `boxsteps`.`conditions` (
  ...
  `plans_id` INT(10) UNSIGNED NULL,
  `users_id` INT(10) UNSIGNED NULL,
  `messages_id` INT(10) UNSIGNED NULL,
  `notifications_id` INT(10) UNSIGNED NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `boxsteps`.`evaluations` (
  ...
  `deleted_at` DATETIME NULL,
  `courses_id` INT(10) UNSIGNED NOT NULL,
  `evaluation_types_id` INT(10) UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
